...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.cdae3e5beb928aa423cb4667a9039cb289a068c307b7785580050f91e6e66aeb.js',function(){input.required=false;search();});}
