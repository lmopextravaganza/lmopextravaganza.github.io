...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.33451021a07362828647a5acaf87d819b28eacc92197424eee97c3ddc296a4c8.js',function(){input.required=false;search();});}
